 ...
 */
class ItemTree extends \ResourceTree\Entity\ItemTree implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'parentItem', 'childItem', 'depth', 'isHere', 'isParent'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ItemTree $proxy) {
    ...
    public function setIsHere($isHere)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsHere', [$isHere]);

        return parent::setIsHere($isHere);
    }
    ...
    public function getChildItem()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getChildItem', []);

        return parent::getChildItem();
    }
