 ...
 */
class ParentItem extends \ResourceTree\Entity\ParentItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'item', 'sort', 'isHere', 'depth', 'childItemId', 'resourceClass', 'targetResourceClassId', 'title', 'values', 'resourceTemplate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ParentItem $proxy) {
    ...
    public function getChildItemId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getChildItemId', []);

        return parent::getChildItemId();
    }
